...
def startup_parameters
  {
      ...
      startup_model_path: VStr.new(non_empty: true),
      startup_scaler_path: VStr.new(non_empty: true)
  }
end
...
def database_parameters
  "
    ...
    add column collect_input_elements int not null,
    add column collect_requests_per_second double not null,
