...
$startup_path = "/mnt/fss/app" # Directory under which the application is installed
$startup_src = "#{$startup_path}/detectron2/tools/train_net.py" # Path to the benchmarked executable of Detectron2
